...
export default function Contato() {
    // 1. Estado para controlar a mensagem de confirmação
    ...
    // 2. useEffect para remover o aviso de sucesso após 5 segundos
    useEffect(() => {
        if (enviado) {
    ...
    const onSubmit = (data: FormularioData) => {
        console.log(data);
        setEnviado(true); // Ativa a mensagem de sucesso
        reset();
    };
    ...
    return (
        ...
        >
            ...
            <Card 
                titulo="Contato" 
                sub="Fale conosco!!" 
                descricao="Na Post UP, nós acreditamos que grandes parcerias começam com uma boa conversa. Se você quer tirar uma ideia do papel, escalar os seus resultados ou apenas entender como podemos ajudar a sua empresa a crescer, você está no lugar certo." 
            />
        ...
        >
            ...
            >
                ...
                {/* Mensagem exibida via useState e controlada pelo useEffect */}
                {enviado && (
                <div className="w-full p-4 mt-2 bg-green-100 border border-green-400 text-green-700 rounded-xl font-bold transition-all">
